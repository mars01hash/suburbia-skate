...
export function Skateboard({ wheelTextureURLs, wheelTextureURL, deckTextureURL, deckTextureURLs, truckColor, boltColor, constantWheelSpin = false, pose = 'upright' }: SkateboardProps) {
